...
public class GerenciadorViagensMontanhaApplication {
	...
	public CommandLineRunner commandLineRunner() {
		return args -> {
			...
			Viagem viagemASerRetornnada = new Viagem();
			viagemASerRetornnada.setLocalDeDestino("Osasco");
			viagemASerRetornnada.setDataPartida(new Date());
			viagemASerRetornnada.setDataRetorno(new Date());
			viagemASerRetornnada.setAcompanhante("Joana");
			viagemASerRetornnada.setRegiao("Sudeste");
			this.viagemRepository.save(viagemASerRetornnada);
